...
Org-fc has been tested with org-mode version 9.3.6,
you can check your version with ~M-x org-version~.
...
This can be disabled by setting ~org-fc-append-failed-cards~ to ~nil~.
